...
class Spotify:
    ...
    def PIL_process(self, pic, name, artists, time, time_at, track):
        ...
        font = ImageFont.truetype(f"assets/spotify.ttf", 28, layout_engine=ImageFont.LAYOUT_BASIC)
        font2 = ImageFont.truetype(f"assets/spotify.ttf", 18, layout_engine=ImageFont.LAYOUT_BASIC)
